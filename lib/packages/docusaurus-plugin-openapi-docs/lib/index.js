...
function pluginOpenAPIDocs(context, options) {
    console.log(chalk_1.default.green(`###### pluginOpenAPIDocs context "${JSON.stringify(context)}"`));
    console.log(chalk_1.default.green(`###### pluginOpenAPIDocs options "${JSON.stringify(options)}"`));
