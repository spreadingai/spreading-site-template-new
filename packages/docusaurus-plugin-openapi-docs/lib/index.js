...
function pluginOpenAPIDocs(context, options) {
    ...
    async function generateApiDocs(options, pluginId) {
        var _a, _b, _c;
        console.log(chalk_1.default.green(`###### generateApiDocs pluginId "${pluginId}"`));
        console.log(chalk_1.default.green(`###### generateApiDocs options "${JSON.stringify(options)}"`));
...
\`\`\`
    ...
    return {
        ...
        // DOCUO: Adapt cli
        extendCli(cli) {
            cli.usage("$0 gen-api-docs --id <id>").command(`gen-api-docs`, `Generates OpenAPI docs in MDX file format and sidebar.js (if enabled).`, () => undefined, async (args, instance) => {
                var _a;
                // DOCUO: Adapt params
                const id = args["id"];
            ...
            cli.usage("$0 gen-api-docs:version --id:version <id:version>").command(`gen-api-docs:version`, `Generates versioned OpenAPI docs in MDX file format, versions.js and sidebar.js (if enabled).`, () => undefined, async (args, instance) => {
                var _a;
                // DOCUO: Adapt params
            ...
            cli.usage("$0 clean-api-docs --id <id>").command(`clean-api-docs`, `Clears the generated OpenAPI docs MDX files and sidebar.js (if enabled).`, () => undefined, async (args, instance) => {
                var _a;
                // DOCUO: Adapt params
                const id = args["id"];
                const options = instance ? instance.opts() : { pluginId: undefined };
            ...
            cli.usage("$0 clean-api-docs:version --id:version <id:version>").command(`clean-api-docs:version`, `Clears the versioned, generated OpenAPI docs MDX files, versions.json and sidebar.js (if enabled).`, () => undefined, async (args, instance) => {
                var _a;
                // DOCUO: Adapt params
                const id = args["id:version"];
                const options = instance ? instance.opts() : { pluginId: undefined };
