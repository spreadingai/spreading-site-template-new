(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var IconCodeAdd = function IconCodeAdd(props) {
    return React.createElement("svg", __assign({
      ...
      viewBox: "0 0 20 20",
      version: "1.1"
    }, props), React.createElement("title", null, "icon_code_add"), React.createElement("g", {
      id: "\u8BBE\u8BA1\uFF08\u6574\u7406\u7248\uFF09",
      stroke: "none",
      strokeWidth: "1",
      fill: "none",
  ...
  var IconCodeDown = function IconCodeDown(props) {
    return React.createElement("svg", __assign({
      ...
      viewBox: "0 0 14 14",
      version: "1.1"
    }, props), React.createElement("title", null, "icon_code_arrow"), React.createElement("g", {
      id: "\u8BBE\u8BA1\uFF08\u6574\u7406\u7248\uFF09",
      stroke: "none",
      strokeWidth: "1",
      fill: "none",
  ...
  var Icons = {
    aspnet: React.createElement(SvgIconLanguageAsp, null),
    c: React.createElement(SvgIconLanguageC$2, null),
    cs: React.createElement(SvgIconLanguageC$1, null),
    clojure: React.createElement(SvgIconLanguageClojure, null),
    cpp: React.createElement(SvgIconLanguageC, null),
    css: React.createElement(SvgIconLanguageCss, null),
    cypher: React.createElement(SvgIconLanguageCypher, null),
    d: React.createElement(SvgIconLanguageD, null),
    dart: React.createElement(SvgIconLanguageDart, null),
    diff: React.createElement(SvgIconLanguageDiff, null),
    docker: React.createElement(SvgIconLanguageDockerfile, null),
    erlang: React.createElement(SvgIconLanguageErlang, null),
    go: React.createElement(SvgIconLanguageGo, null),
    graphql: React.createElement(SvgIconLanguageGraphql, null),
    groovy: React.createElement(SvgIconLanguageGroovy, null),
    handlebars: React.createElement(SvgIconLanguageHandlebars, null),
    haml: React.createElement(SvgIconLanguageHaml, null),
    haxe: React.createElement(SvgIconLanguageHaxe, null),
    html: React.createElement(SvgIconLanguageHtml, null),
    http: React.createElement(SvgIconLanguageHttp, null),
    java: React.createElement(SvgIconLanguageJava, null),
    javascript: React.createElement(SvgIconLanguageJavascript, null),
    json: React.createElement(SvgIconLanguageJson, null),
    kotlin: React.createElement(SvgIconLanguageKotlin, null),
    less: React.createElement(SvgIconLanguageLess, null),
    liquid: React.createElement(SvgIconLanguageLiquid, null),
    markdown: React.createElement(SvgIconLanguageMarkdown, null),
    objectivec: React.createElement(SvgIconLanguageObjectiveC, null),
    ocaml: React.createElement(SvgIconLanguageOcaml, null),
    perl: React.createElement(SvgIconLanguagePerl, null),
    php: React.createElement(SvgIconLanguagePhp, null),
    powershell: React.createElement(SvgIconLanguagePowershell, null),
    python: React.createElement(SvgIconLanguagePython, null),
    r: React.createElement(SvgIconLanguageR, null),
    ruby: React.createElement(SvgIconLanguageRuby, null),
    rust: React.createElement(SvgIconLanguageRust, null),
    sass: React.createElement(SvgIconLanguageScss, null),
    scala: React.createElement(SvgIconLanguageScala, null),
    scss: React.createElement(SvgIconLanguageScss, null),
    bash: React.createElement(SvgIconLanguageShell, null),
    smarty: React.createElement(SvgIconLanguageSmarty, null),
    solidity: React.createElement(SvgIconLanguageSolidity, null),
    sql: React.createElement(SvgIconLanguageSql, null),
    stylus: React.createElement(SvgIconLanguageStylus, null),
    swift: React.createElement(SvgIconLanguageSwift, null),
    toml: React.createElement(SvgIconLanguageToml, null),
    twig: React.createElement(SvgIconLanguageTwig, null),
    typescript: React.createElement(SvgIconLanguageTypescript, null),
    xml: React.createElement(SvgIconLanguageXml, null),
    yaml: React.createElement(SvgIconLanguageYaml, null)
  };
  var CodeIcon = function CodeIcon(props) {
    var Tag = props.iconName.toLowerCase();
    return Icons[Tag] || React.createElement(SvgIconLanguagePlaintext, null);
  };
  ...
  var SCodeBlockTab = function SCodeBlockTab(props) {
    ...
    var _c = React.useState(props.codes || []),
      codes = _c[0],
      setCodes = _c[1];
    var codeWrapperRef = React.useRef();
    var tabListRef = React.useRef();
    var _d = React.useState(0),
      selectIndex = _d[0],
      setSelectIndex = _d[1];
    var _e = React.useState(720),
      width = _e[0],
      setWidth = _e[1];
    var tabIdIndexRef = React.useRef(-1);
    // 站点和编辑器切换 tab 要隐藏的元素
    var codeBlockSelector = !!editor ? "[data-code-block-wrapper]" : "[data-code-block]";
    var switchID = React.useRef("switch_".concat(Math.floor(Math.random() * 0xffffffff)));
    ...
    return React.createElement("div", {
      ...
      }, code.filename), editable && selectIndex === index && React.createElement("span", {
        className: styles$7.tab_arrow_icon
      }, React.createElement(IconCodeDown, null)));
    })), editable && React.createElement("span", {
      className: styles$7.tab_add_icon,
      onClick: handleAddTab
    }, React.createElement(IconCodeAdd, null)), editable && React.createElement("div", {
      className: styles$7.tab_blank
    }), editable && !editor.isToolEditor && React.createElement("div", {
      className: styles$7.tab_ai_switch_wrapper
    }, React.createElement("label", {
      htmlFor: "ai"
    }, "Code with ", React.createElement("span", {
  ...
  */
  ...
  var SCodeBlock = function SCodeBlock(props) {
    ...
    var codeBlockRef = React.useRef();
    var resizerPreRef = React.useRef();
    ...
    var calcLineHeights = React.useCallback(function () {
      var _a, _b, _c;
      if (!autoWrap) return;
      var codeBlockEl = codeBlockRef.current;
    ...
    }, children, showLineNumber ? React.createElement("div", {
      contentEditable: false,
    ...
    }, React.createElement("span", null)))), (editor && !(node === null || node === void 0 ? void 0 : node.attrs.aiEnabled) || !editor) && React.createElement("div", {
    ...
    }, React.createElement(SvgIconCopy, null), "Copy"));
  };
  ...
  var SImage = function SImage(props) {
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", {
      ...
      title: title,
      style: imageStyle
    }), !editable && !!caption && React.createElement("p", {
      className: styles$4.image_desc,
      style: {
        width: width
      }
    }, caption)), !editable && open && React.createElement("div", {
  ...
  var SVideo = function SVideo(props) {
    ...
    return React.createElement("div", {
      ...
      className: className
    }, React.createElement("iframe", __assign({
      style: {
        position: "absolute",
        top: 0,
        left: 0,
  ...
  var SCalloutContent = function SCalloutContent(props) {
    ...
    }, children || React.createElement("br", null));
  };
  ...
  var STable = function STable(_a) {
    ...
    }, colgroup && React.createElement("colgroup", null, colgroupData.map(function (col, index) {
  ...
  var SQuote = function SQuote(props) {
    return React.createElement("blockquote", null, props.children || React.createElement("br", null));
  };

  exports.SCallout = SCallout;
  exports.SCalloutContent = SCalloutContent;
  exports.SCalloutHeader = SCalloutHeader;
  exports.SCodeBlock = SCodeBlock;
  exports.SCodeBlockTab = SCodeBlockTab;
  exports.SH = SH;
  exports.SImage = SImage;
  exports.SQuote = SQuote;
  exports.STable = STable;
  exports.STableCell = STableCell;
  exports.STableHeader = STableHeader;
  exports.STableRow = STableRow;
  exports.STitle = STitle;
  exports.SVideo = SVideo;
