...
| 6000324 | 房间同时存在数量达到上限。| 请勿超过房间同时存在数量上限，上限详情请参考 [计费说明](/zim-android/introduction/pricing#版本差异) 中的“版本差异”。|
| 6000325 | 用户同时加入多个房间数量达到上限。| 请勿超过用户同时加入房间上限，上限详情请参考 [计费说明](/zim-android/introduction/pricing#版本差异) 中的“版本差异”。|
