...
独唱方案，用户上麦后自由点歌后进行排麦演唱。演唱者进行歌曲演唱时，将麦克风人声和媒体播放器声音进行混流，观众在台下接收音频流。具体实现请查看 [独唱方案](/online-ktv-web/implementation/ktv-solutions/solo)。
...
可以参考 [点歌管理](/online-ktv-web/implementation/song-selection) 实现排麦和已点列表功能。

#### 正版曲库

ZEGO 正版曲库支持歌单展示、搜索歌曲、点歌，逐字歌词下载等。更多具体的内容查看 [ZEGO 内容中心 - 点歌](/online-ktv-web/zego-content-center/sing-songs)。
...
更多具体的内容查看 [评分功能](/online-ktv-web/implementation/vocal-scoring)。
