...
- [totalRecvBytes](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~cpp_windows~struct~ZegoPlayStreamQuality#total-recv-bytes)：已接收的总字节数，包括音频、视频和 SEI 等
