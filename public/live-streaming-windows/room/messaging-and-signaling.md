...
1. **发送广播消息**
    ...
    ```cpp
    // 发送广播消息
    engine->sendBroadcastMessage("ChatRoom-1", "This is a broadcast message", [=](/live-streaming-windows/room/int-errorcode,-unsigned-long-long-messageid){
...
1. **发送弹幕消息**
    ...
    ```cpp
    // 发送弹幕消息
    engine->sendBarrageMassage("ChatRoom-1", "This is a barrage message", [=](/live-streaming-windows/room/int-errorcode,-std::string-messageid){
...
1. **发送自定义信令**
    ...
    engine->sendCustomCommand("ChatRoom-1", "This is a custom command", toUserList, [=](/live-streaming-windows/room/int-errorcode){
