...
详情请参考 [快速开始 - 实现流程](https://doc-zh.zego.im/article/13416#CreateEngine) 的“初始化”章节。
...
详情请参考 [快速开始 - 实现流程](https://doc-zh.zego.im/article/13416#createroom) 的“登录房间”房间章节。
...
- 当开发者使用 ZEGO 配置的 CDN 进行直推时，则可以直接通过 streamID 进行拉流，请参考 [快速开始 - 实现视频通话](https://doc-zh.zego.im/article/13416#3_4) 的 “拉流”。
