...
当离线登录成功时，{getPlatformData2(props,connectionStateChangedMap)} 返回 [ZIMConnectionState](https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~enum~ZIMConnectionState) 为 Connecting（枚举值为 1）。
