...
zim_->updateUserExtendedData(new_user_extended_data, [=](/zim-uniapp/guides/users/const-std::string-&extended_data,-zim::zimerror-error_info){
...
zim_->updateUserName(new_user_name, [=](/zim-uniapp/guides/users/const-std::string-&username,-const-zim::zimerror-&errorinfo){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 修改成功
    }
});
...
zim_->updateUserAvatarUrl(user_avatar_url, [=](/zim-uniapp/guides/users/const-std::string-&useravatarurl,-zim::zimerror-error_info){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
         // 操作成功
    }
});
...
zim_->queryUsersInfo(user_id_list, config, [=](/zim-uniapp/guides/users/const-std::vector<zim::zimuserfullinfo>-&userlist,-const-std::vector<zim::zimerroruserinfo>-&erroruserlist,-const-zim::zimerror-&errorinfo) {
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 查询成功
    }
});
