...
<Warning title="注意">
即时通讯产品在 `2.0.0` 版本（版本说明请参考 [发布日志](/zim-uniapp/client-sdks/zim-release-notes)）有较大程度的更新，如果您使用的版本低于 `2.0.0`，请参考 [1.x.x 版本错误码](https://doc-zh.zego.im/article/14511) 处理。
...
| 6000013 | 当前套餐不支持该操作。 | 请确认您的套餐权限，详情请参考 [计费说明](/zim-uniapp/introduction/pricing)。 |
...
| 6000213 | 不支持的图片/音频/视频格式。  | 请先确认文件格式是否正确，支持的文件格式请参考 [消息类型](/zim-uniapp/guides/messaging/send-and-receive-messages#消息类型)。 |
| 6000214 | 富媒体文件大小异常。  | 请先确认文件大小是否正确，大小限制请参考 [消息类型](/zim-uniapp/guides/messaging/send-and-receive-messages#消息类型)。 |
| 6000215 | 音频文件时长异常。  | 请先确认时长是否正确，时长限制请参考 [消息类型](/zim-uniapp/guides/messaging/send-and-receive-messages#消息类型)。 |
...
| 6000324 | 房间同时存在数量达到上限。| 请勿超过房间同时存在数量上限，上限详情请参考 [计费说明](/zim-uniapp/introduction/pricing#版本差异) 中的“版本差异”。|
| 6000325 | 用户同时加入多个房间数量达到上限。| 请勿超过用户同时加入房间上限，上限详情请参考 [计费说明](/zim-uniapp/introduction/pricing#版本差异) 中的“版本差异”。|
...
| 6000525 | 群成员达到上限。 | 请勿超过群组人数上限，上限详情请参考 [计费说明](/zim-uniapp/introduction/pricing#版本差异) 中的“版本差异”。 |
