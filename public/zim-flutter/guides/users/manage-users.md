...
export const updateUserExtendedData={
    "Android": <a href="https://doc-zh.zego.im" target="_blank">updateUserExtendedData</a>,
    "u3d": <a href="https://doc-zh.zego.im" target="_blank">UpdateUserExtendedData</a>,
...
export const ZIMUserInfo={
    "Android": <a href="https://doc-zh.zego.im" target="_blank">ZIMUserInfo</a>,
...
export const updateUserName={
    "Android": <a href="https://doc-zh.zego.im" target="_blank">updateUserName</a>,
    "u3d": <a href="https://doc-zh.zego.im" target="_blank">UpdateUserName</a>,
...
export const updateUserAvatarUrl={
    "Android": <a href="https://doc-zh.zego.im" target="_blank">updateUserAvatarUrl</a>,
    "u3d": <a href="https://doc-zh.zego.im" target="_blank">UpdateUserAvatarUrl</a>,
...
export const queryUsersInfo={
    "Android": <a href="https://doc-zh.zego.im" target="_blank">queryUsersInfo</a>,
    "u3d": <a href="https://doc-zh.zego.im" target="_blank">QueryUsersInfo</a>,
...
export const isQueryFromServer={
    "Android": <a href="https://doc-zh.zego.im" target="_blank">isQueryFromServer</a>,
...
export const ZIMUsersInfoQueryConfig={
    "Android": <a href="https://doc-zh.zego.im" target="_blank">ZIMUsersInfoQueryConfig</a>,
...
zim_->updateUserExtendedData(new_user_extended_data, [=](/zim-flutter/guides/users/const-std::string-&extended_data,-zim::zimerror-error_info){
...
zim_->updateUserName(new_user_name, [=](/zim-flutter/guides/users/const-std::string-&username,-const-zim::zimerror-&errorinfo){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 修改成功
    }
});
...
zim_->updateUserAvatarUrl(user_avatar_url, [=](/zim-flutter/guides/users/const-std::string-&useravatarurl,-zim::zimerror-error_info){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
         // 操作成功
    }
});
...
zim_->queryUsersInfo(user_id_list, config, [=](/zim-flutter/guides/users/const-std::vector<zim::zimuserfullinfo>-&userlist,-const-std::vector<zim::zimerroruserinfo>-&erroruserlist,-const-zim::zimerror-&errorinfo) {
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 查询成功
    }
});
