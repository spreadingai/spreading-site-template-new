...
如果需要设置自定义变声，请查看 [设置自定义变声](https://doc-zh.zego.im/article/20976#4_1_2)。
...
[ZegoVoiceChangerPreset](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/ets_ohos/enums/_zegoexpressdefines_.zegovoicechangerpreset.html) 预置的变声效果如下，开发者可以根据需要选择：
...
如果需要设置预设变声，请查看 [设置预设变声](https://doc-zh.zego.im/article/20976#4_1_1)。
...
如果需要设置自定义混响，请查看 [设置自定义混响](https://doc-zh.zego.im/article/20976#4_2_2)。
...
如果需要设置预设混响，请查看 [设置预设混响](https://doc-zh.zego.im/article/20976#4_2_1)。
