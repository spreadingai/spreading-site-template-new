...
<tr>
<td>[RTMP 推流到 ZEGO 服务器](https://doc-zh.zego.im/article/16835)</td>
<td>在直播场景下，主播可以通过 RTMP 推流工具将音视频流推送到 ZEGO 服务器，实现低延迟的效果。</td>
<td>直播场景。</td>
</tr>
<tr>
<td>[混流](https://doc-zh.zego.im/article/16061)</td>
...
<tr>
<td>[使用本地导播](https://doc-zh.zego.im/article/18454)</td>
<td>在本地对画面和声音进行混合，将多路音视频流或页面元素、合并为一路音视频流后推流，助力开发者实现更丰富的场景。</td>
<td>直播场景。</td>
</tr>
</tbody></table>
...
<tr>
<td>[直播连麦](https://doc-zh.zego.im/article/16050)</td>
...
<tr>
<td>[房间连接状态说明](https://doc-zh.zego.im/article/16034)</td>
<td>判断用户在房间内的连接状态，以及各个连接状态的转化过程。</td>
<td>-</td>
</tr>
<tr>
<td>[实时消息与信令](https://doc-zh.zego.im/article/16036)</td>
...
<tr>
<td>[登录多房间](https://doc-zh.zego.im/article/16046)</td>
...
<tr>
<td>[音频频谱与音量变化](https://doc-zh.zego.im/article/16062)</td>
...
<tr>
<td>[耳返与声道设置](https://doc-zh.zego.im/article/16042)</td>
...
<tr>
<td>[音频 3A 处理](https://doc-zh.zego.im/article/16044) </td>
...
<tr>
<td>[变声/混响/立体声](https://doc-zh.zego.im/article/18148)  </td>
...
<tr>
<td>[混音](https://doc-zh.zego.im/article/16073)</td>
<td>SDK 从 App 获取一路音频数据，将 App 提供的音频数据与 SDK 采集的音频数据整合为一路音频数据，从而实现在通话或直播过程中播放自定义的声音、音乐文件，并且让房间内的其他人也听到的能力。</td>
<td><ul><li>社交语聊</li> <li>直播</li></ul></td>
</tr>
<tr>
<td>[AI 降噪](https://doc-zh.zego.im/article/16571)</td>
...
<tr>
<td>[自定义音频采集](https://doc-zh.zego.im/article/16063)</td>
...
<tr>
<td>[常用视频配置](https://doc-zh.zego.im/article/16059)</td>
<td>在直播时，自定义设置采集及播放的视频相关配置，如视频采集分辨率、视频编码输出分辨率、视频帧率、视频码率、视图模式和镜像模式等。</td>
<td>对分辨率、码率、镜像等有特殊要求的场景。</td>
</tr>
<tr>
<td>[基础美颜](https://doc-zh.zego.im/article/16037)</td>
<td>当在视频通话或直播时，希望向对方呈现出良好的肌肤状态，可结合 [AI 美颜](/ai-effects-android-java/overview/overview) 实现基础美颜功能。</td>
<td><ul><li>秀场直播</li> <li>音视频通话</li></ul></td>
</tr>
<tr>
<td>[屏幕共享](https://doc-zh.zego.im/article/16053)</td>
...
<tr>
<td>[设置视频编码方式](https://doc-zh.zego.im/article/16039) </td>
<td>可对视频的编解码进行详细设置，包括启用分层视频编码、使用硬件编解码和设置编码方式等。</td>
<td>对编解码有特殊要求时。</td>
</tr>
<tr>
<td>[自定义视频采集](https://doc-zh.zego.im/article/16041)</td>
...
<tr>
<td>[背景虚化及虚拟背景](https://doc-zh.zego.im/article/17811)</td>
<td><p>将视频画面中的主体从原始画面中分离出来，并对主体外的区域做如下处理：</p><ul><li>虚化主体外的区域</li><li>以自定义图片替换主体外的区域</li></ul></td>
<td><ul><li>在线会议</li><li>远程教育</li><li>视频通话</li></ul></td>
</tr>
</tbody></table>
...
<tr>
<td>[音效文件播放器](https://doc-zh.zego.im/article/16043)</td>
