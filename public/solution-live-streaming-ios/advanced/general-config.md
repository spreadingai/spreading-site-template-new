...
- 如需将视频逆时针旋转 90 度，将参数设置为 `UIInterfaceOrientationLandscapeLeft`。
...
- 如果您使用 [自定义视频采集](https://doc-zh.zego.im/article/3676) 进行视频数据捕获，在设备屏幕方向更改后，实现 G-Sensor 模式，请参考以下两种方法：
  - **方式 1**：自己处理视频帧数据。     
