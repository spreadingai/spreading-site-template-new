...
如果需要设置自定义变声，请查看 [设置自定义变声](https://doc-zh.zego.im/article/4304#4_1_2)。
</Note>
...
如果需要设置预设变声，请查看 [设置预设变声](https://doc-zh.zego.im/article/4304#4_1_1)。
</Note>
...
如果需要设置自定义混响，请查看 [设置自定义混响](https://doc-zh.zego.im/article/4304#4_2_2)。
</Note>
...
如果需要设置预设混响，请查看 [设置预设混响](https://doc-zh.zego.im/article/4304#4_2_1)。
</Note>
