...
创建 ZegoExpressEngine 引擎流程，请参考实现视频通话的 [创建引擎](https://doc-zh.zego.im/article/7629#CreateEngine)。
...
登录房间及推流流程，请参考实现视频通话的 [登录房间](https://doc-zh.zego.im/article/7629#createroom) 及 [推流](https://doc-zh.zego.im/article/7629#publishingStream) 。
...
结束推流流程，请参考实现视频通话的 [停止推拉流](https://doc-zh.zego.im/article/7629#stopPublishingStream)。
