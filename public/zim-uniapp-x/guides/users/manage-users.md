...
export const updateUserExtendedData={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~class~ZIM#update-user-extended-data" target="_blank">updateUserExtendedData</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~class~ZIM#update-user-extended-data" target="_blank">UpdateUserExtendedData</a>,
...
export const extendedDataUpdatedCallback={
    ...
    "Web,RN,UTS": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~interface~ZIMUserExtendedDataUpdatedResult" target="_blank">ZIMUserExtendedDataUpdatedResult</a>,
...
export const ZIMUserInfo={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~interface~ZIMUserInfo" target="_blank">ZIMUserInfo</a>,
...
export const updateUserName={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~class~ZIM#update-user-name" target="_blank">updateUserName</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~class~ZIM#update-user-name" target="_blank">UpdateUserName</a>,
...
export const ZIMUserNameUpdatedCallback={
    ...
    "Web,RN,UTS": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~interface~ZIMUserNameUpdatedResult" target="_blank">ZIMUserNameUpdatedResult</a>,
...
export const updateUserAvatarUrl={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~class~ZIM#update-user-avatar-url" target="_blank">updateUserAvatarUrl</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~class~ZIM#update-user-avatar-url" target="_blank">UpdateUserAvatarUrl</a>,
...
export const ZIMUserAvatarUrlUpdatedCallback={
    ...
    "Web,RN,UTS": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~interface~ZIMUserAvatarUrlUpdatedResult" target="_blank">ZIMUserAvatarUrlUpdatedResult</a>,
...
export const queryUsersInfo={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~class~ZIM#query-users-info" target="_blank">queryUsersInfo</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~class~ZIM#query-users-info" target="_blank">QueryUsersInfo</a>,
...
export const ZIMUsersInfoQueriedCallback={
    ...
    "Web,RN,UTS": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~interface~ZIMUsersInfoQueriedResult" target="_blank">ZIMUsersInfoQueriedResult</a>,
...
export const isQueryFromServer={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~interface~ZIMUsersInfoQueryConfig#is-query-from-server" target="_blank">isQueryFromServer</a>,
...
export const ZIMUsersInfoQueryConfig={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~javascript_uni-app~interface~ZIMUsersInfoQueryConfig" target="_blank">ZIMUsersInfoQueryConfig</a>,
...
zim_->updateUserExtendedData(new_user_extended_data, [=](/zim-uniapp-x/guides/users/const-std::string-&extended_data,-zim::zimerror-error_info){
...
zim_->updateUserName(new_user_name, [=](/zim-uniapp-x/guides/users/const-std::string-&username,-const-zim::zimerror-&errorinfo){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 修改成功
    }
});
...
zim_->updateUserAvatarUrl(user_avatar_url, [=](/zim-uniapp-x/guides/users/const-std::string-&useravatarurl,-zim::zimerror-error_info){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
         // 操作成功
    }
});
...
zim_->queryUsersInfo(user_id_list, config, [=](/zim-uniapp-x/guides/users/const-std::vector<zim::zimuserfullinfo>-&userlist,-const-std::vector<zim::zimerroruserinfo>-&erroruserlist,-const-zim::zimerror-&errorinfo) {
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 查询成功
    }
});
