...
4. 调用 [getCurrentPitch](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_react-native/classes/_zegoexpressdefines_.zegocopyrightedmusic.html#getcurrentpitch) 接口获取当前演唱声音的音高数组。
