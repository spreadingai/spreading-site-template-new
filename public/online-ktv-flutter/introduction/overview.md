...
:::if{props.platform=undefined}
此方案可以实现排麦独唱玩法，详见 [独唱方案](/online-ktv-flutter/implementation/ktv-solutions/solo)。
:::
...
:::if{props.platform=undefined}
此方案可以实现实时合唱玩法，详见 [实时合唱方案](/online-ktv-flutter/implementation/ktv-solutions/chorus/concurrent)。
:::
...
:::if{props.platform=undefined}
此方案可以实现串行合唱玩法，详见 [串行合唱方案](/online-ktv-flutter/implementation/ktv-solutions/chorus/serial)。
:::
...
:::if{props.platform=undefined}
此方案可以实现抢唱玩法，详见 [抢唱方案](/online-ktv-flutter/implementation/ktv-solutions/grab-the-mic)。
:::
