...
具体流程请参考“实现视频通话”文档的 [创建引擎](https://doc-zh.zego.im/article/13395#createEngine) 和 [登录房间](https://doc-zh.zego.im/article/13395#loginRoom) 章节。
...
配置 [ZegoPlayerConfig](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~java_android~class~ZegoPlayerConfig) 的 codecTemplateID 属性，填写 [步骤 1 添加转码配置模板](https://doc-zh.zego.im/article/17787#step1) 中获取的转码模板 ID，并开始拉流。
