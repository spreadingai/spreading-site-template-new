...
export const updateUserExtendedData={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIM#update-user-extended-data-extended-data-callback" target="_blank">updateUserExtendedData</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIM#update-user-extended-data-extended-data-callback" target="_blank">UpdateUserExtendedData</a>,
...
export const extendedDataUpdatedCallback={
    ...
    "iOS,Windows,u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~class~ZIMDefines#zim-user-extended-data-updated-callback" target="_blank">ZIMUserExtendedDataUpdatedCallback</a>,
...
export const ZIMUserInfo={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~class~ZIMUserInfo" target="_blank">ZIMUserInfo</a>,
...
export const updateUserName={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIM#update-user-name-user-name-callback" target="_blank">updateUserName</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIM#update-user-name-user-name-callback" target="_blank">UpdateUserName</a>,
...
export const ZIMUserNameUpdatedCallback={
    ...
    "iOS,Windows,u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~class~ZIMDefines#zim-user-name-updated-callback" target="_blank">ZIMUserNameUpdatedCallback</a>,
...
export const updateUserAvatarUrl={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIM#update-user-avatar-url-user-avatar-url-callback" target="_blank">updateUserAvatarUrl</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIM#update-user-avatar-url-user-avatar-url-callback" target="_blank">UpdateUserAvatarUrl</a>,
...
export const ZIMUserAvatarUrlUpdatedCallback={
    ...
    "iOS,Windows,u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~class~ZIMDefines#zim-user-avatar-url-updated-callback" target="_blank">ZIMUserAvatarUrlUpdatedCallback</a>,
...
export const queryUsersInfo={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIM#query-users-info-user-i-ds-config-callback" target="_blank">queryUsersInfo</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIM#query-users-info-user-i-ds-config-callback" target="_blank">QueryUsersInfo</a>,
...
export const ZIMUsersInfoQueriedCallback={
    ...
    "iOS,Windows,u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~class~ZIMDefines#zim-users-info-queried-callback" target="_blank">ZIMUsersInfoQueriedCallback</a>,
...
export const isQueryFromServer={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~class~ZIMUsersInfoQueryConfig#is-query-from-server" target="_blank">isQueryFromServer</a>,
...
export const ZIMUsersInfoQueryConfig={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~class~ZIMUsersInfoQueryConfig" target="_blank">ZIMUsersInfoQueryConfig</a>,
...
zim_->updateUserExtendedData(new_user_extended_data, [=](/zim-macos/guides/users/const-std::string-&extended_data,-zim::zimerror-error_info){
...
zim_->updateUserName(new_user_name, [=](/zim-macos/guides/users/const-std::string-&username,-const-zim::zimerror-&errorinfo){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 修改成功
    }
});
...
zim_->updateUserAvatarUrl(user_avatar_url, [=](/zim-macos/guides/users/const-std::string-&useravatarurl,-zim::zimerror-error_info){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
         // 操作成功
    }
});
...
zim_->queryUsersInfo(user_id_list, config, [=](/zim-macos/guides/users/const-std::vector<zim::zimuserfullinfo>-&userlist,-const-std::vector<zim::zimerroruserinfo>-&erroruserlist,-const-zim::zimerror-&errorinfo) {
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 查询成功
    }
});
