...
如果需要设置自定义变声，请查看 [设置自定义变声](https://doc-zh.zego.im/article/6895#3_1_2)。
...
如果需要设置预设变声，请查看 [设置预设变声](https://doc-zh.zego.im/article/6895#3_1_1)。
...
如果需要设置自定义混响，请查看 [设置自定义混响](https://doc-zh.zego.im/article/6895#3_2_2)。
...
如果需要设置预设混响，请查看 [设置预设混响](https://doc-zh.zego.im/article/6895#3_2_1)。
