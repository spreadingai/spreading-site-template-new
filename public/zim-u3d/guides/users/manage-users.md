...
export const updateUserExtendedData={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIM#update-user-extended-data" target="_blank">updateUserExtendedData</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIM#update-user-extended-data" target="_blank">UpdateUserExtendedData</a>,
...
export const extendedDataUpdatedCallback={
    ...
    "iOS,Windows,u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~interface~ZIMDefines#zim-user-extended-data-updated-callback" target="_blank">ZIMUserExtendedDataUpdatedCallback</a>,
...
export const ZIMUserInfo={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIMUserInfo" target="_blank">ZIMUserInfo</a>,
...
export const updateUserName={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIM#update-user-name" target="_blank">updateUserName</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIM#update-user-name" target="_blank">UpdateUserName</a>,
...
export const ZIMUserNameUpdatedCallback={
    ...
    "iOS,Windows,u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~interface~ZIMDefines#zim-user-name-updated-callback" target="_blank">ZIMUserNameUpdatedCallback</a>,
...
export const updateUserAvatarUrl={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIM#update-user-avatar-url" target="_blank">updateUserAvatarUrl</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIM#update-user-avatar-url" target="_blank">UpdateUserAvatarUrl</a>,
...
export const ZIMUserAvatarUrlUpdatedCallback={
    ...
    "iOS,Windows,u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~interface~ZIMDefines#zim-user-avatar-url-updated-callback" target="_blank">ZIMUserAvatarUrlUpdatedCallback</a>,
...
export const queryUsersInfo={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIM#query-users-info" target="_blank">queryUsersInfo</a>,
    "u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIM#query-users-info" target="_blank">QueryUsersInfo</a>,
...
export const ZIMUsersInfoQueriedCallback={
    ...
    "iOS,Windows,u3d": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~interface~ZIMDefines#zim-users-info-queried-callback" target="_blank">ZIMUsersInfoQueriedCallback</a>,
...
export const isQueryFromServer={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIMUsersInfoQueryConfig#is-query-from-server" target="_blank">isQueryFromServer</a>,
...
export const ZIMUsersInfoQueryConfig={
    "Android": <a href="https://doc-zh.zego.im/article/api?doc=zim_API~cs_unity3d~class~ZIMUsersInfoQueryConfig" target="_blank">ZIMUsersInfoQueryConfig</a>,
...
zim_->updateUserExtendedData(new_user_extended_data, [=](/zim-u3d/guides/users/const-std::string-&extended_data,-zim::zimerror-error_info){
...
zim_->updateUserName(new_user_name, [=](/zim-u3d/guides/users/const-std::string-&username,-const-zim::zimerror-&errorinfo){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 修改成功
    }
});
...
zim_->updateUserAvatarUrl(user_avatar_url, [=](/zim-u3d/guides/users/const-std::string-&useravatarurl,-zim::zimerror-error_info){
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
         // 操作成功
    }
});
...
zim_->queryUsersInfo(user_id_list, config, [=](/zim-u3d/guides/users/const-std::vector<zim::zimuserfullinfo>-&userlist,-const-std::vector<zim::zimerroruserinfo>-&erroruserlist,-const-zim::zimerror-&errorinfo) {
    if (errorInfo.code == ZIM_ERROR_CODE_SUCCESS) {
        // 查询成功
    }
});
