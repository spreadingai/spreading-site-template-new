...
<Button primary-color="NavyBlue" target="_blank" href="/live-streaming-macos/client-sdk/download-sdk">下载 SDK</Button>
<Button primary-color="NavyBlue" target="_blank" href="/live-streaming-macos/quick-start/implementing-live-streaming">快速开始</Button>
  ...
  <Step title="产品介绍" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_jianjie.png">
    <FeatureList
      features={        [
                {
                        "title": "概述",
                        "link": "/live-streaming-macos/introduction/overview"
                },
                {
                        "title": "产品功能",
                        "link": "/live-streaming-macos/introduction/product-feature-list"
                }
        ]}
    />
  </Step>
  <Step title="快速开始" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_kuaisukaishi.png">
    <FeatureList
      features={        [
                {
                        "title": "跑通示例源码",
                        "link": "/live-streaming-macos/quick-start/run-example-code"
                },
                {
                        "title": "集成 SDK",
                        "link": "/live-streaming-macos/quick-start/integrating-sdk"
                },
                {
                        "title": "快速实现超低延迟直播",
                        "link": "/live-streaming-macos/quick-start/implementing-live-streaming"
                },
                {
                        "title": "场景化音视频配置",
                        "link": "/live-streaming-macos/quick-start/scenario-based-audio-video-configuration"
                }
        ]}
    />
  </Step>
  <Step title="直播能力" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_zhibo.png">
    <FeatureList
      ...
      features={        [
                {
                        "title": "混流",
                        "link": "/live-streaming-macos/live-streaming/stream-mixing"
                }
        ]}
    />
    <br/>
    <FeatureList
      ...
      features={        [
                {
                        "title": "单流转码",
                        "link": "/live-streaming-macos/live-streaming/single-stream-transcoding"
                },
                {
                        "title": "RTMP 推流到 ZEGO 服务器",
                        "link": "/live-streaming-macos/live-streaming/obs-push"
                }
        ]}
    />
  </Step>
  <Step title="通信能力" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_tongxun.png">
    <FeatureList
      ...
      features={        [
                {
                        "title": "使用 Token 鉴权",
                        "link": "/live-streaming-macos/communication/use-token-authentication"
                },
                {
                        "title": "通话质量监测",
                        "link": "/live-streaming-macos/communication/monitor-stream-quality"
                },
                {
                        "title": "网络测速",
                        "link": "/live-streaming-macos/communication/testing-network"
                }
        ]}
    />
    <br/>
    <FeatureList
      ...
      features={        [
                {
                        "title": "多源采集",
                        "link": "/live-streaming-macos/communication/multi-source-capture"
                },
                {
                        "title": "同时推多路流",
                        "link": "/live-streaming-macos/communication/push-multiple-streams"
                },
                {
                        "title": "媒体补充增强信息（SEI）",
                        "link": "/live-streaming-macos/communication/sei"
                },
                {
                        "title": "云代理",
                        "link": "/live-streaming-macos/communication/cloud-proxy"
                },
                {
                        "title": "游戏语音",
                        "link": "/live-streaming-macos/communication/range-audio"
                }
        ]}
    />
  </Step>
  <Step title="房间能力" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_fangjian.png">
    <FeatureList
      ...
      features={        [
                {
                        "title": "房间连接状态说明",
                        "link": "/live-streaming-macos/room/room-connection-status"
                },
                {
                        "title": "实时消息与信令",
                        "link": "/live-streaming-macos/room/messaging-and-signaling"
                }
        ]}
    />
    <br/>
    <FeatureList
      ...
      features={        [
                {
                        "title": "登录多房间",
                        "link": "/live-streaming-macos/room/multi-room-login"
                }
        ]}
    />
  </Step>
  <Step title="音频能力" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_yinpin.png">
    <FeatureList
      ...
      features={        [
                {
                        "title": "音频频谱与音量变化",
                        "link": "/live-streaming-macos/audio/sound-level-spectrum"
                },
                {
                        "title": "耳返与声道设置",
                        "link": "/live-streaming-macos/audio/headphone-monitor"
                },
                {
                        "title": "音频 3A 处理",
                        "link": "/live-streaming-macos/audio/audio-3a-processing"
                },
                {
                        "title": "变声/混响/立体声",
                        "link": "/live-streaming-macos/audio/audio-effects"
                }
        ]}
    />
    <br/>
    <FeatureList
      ...
      features={        [
                {
                        "title": "场景化 AI 降噪",
                        "link": "/live-streaming-macos/audio/scenario-based-ai-noise-reduction"
                },
                {
                        "title": "自定义音频采集与渲染",
                        "link": "/live-streaming-macos/audio/custom-audio-capture-and-rendering"
                },
                {
                        "title": "自定义音频处理",
                        "link": "/live-streaming-macos/audio/custom-audio-processing"
                }
        ]}
    />
    <br/>
    <FeatureList
      features={        [
                {
                        "title": "原始音频数据获取",
                        "link": "/live-streaming-macos/audio/get-audio-raw-data"
                }
        ]}
    />
  </Step>
  <Step title="视频能力" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_shipin.png">
    <FeatureList
      ...
      features={        [
                {
                        "title": "常用视频配置",
                        "link": "/live-streaming-macos/video/common-video-configuration"
                },
                {
                        "title": "屏幕共享",
                        "link": "/live-streaming-macos/video/screen-sharing"
                },
                {
                        "title": "水印和截图",
                        "link": "/live-streaming-macos/video/watermark-and-screenshot"
                }
        ]}
    />
    <br/>
    <FeatureList
      ...
      features={        [
                {
                        "title": "设置视频编码方式",
                        "link": "/live-streaming-macos/video/set-video-encoding"
                },
                {
                        "title": "自定义视频采集",
                        "link": "/live-streaming-macos/video/custom-video-capture"
                },
                {
                        "title": "自定义视频渲染",
                        "link": "/live-streaming-macos/video/custom-video-rendering"
                },
                {
                        "title": "主体分割",
                        "link": "/live-streaming-macos/video/object-segmentation"
                },
                {
                        "title": "视频大小流和分层编码",
                        "link": "/live-streaming-macos/video/small-large-video-stream-and-layered-encoding"
                },
                {
                        "title": "推流视频增强",
                        "link": "/live-streaming-macos/video/publish-video-enhancement"
                }
        ]}
    />
  </Step>
  <Step title="其他能力" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_xiaoxi_2.png">
    <FeatureList
      ...
      features={        [
                {
                        "title": "媒体播放器",
                        "link": "/live-streaming-macos/other/media-player"
                },
                {
                        "title": "音效文件播放器",
                        "link": "/live-streaming-macos/other/audio-effect-player"
                },
                {
                        "title": "音视频录制",
                        "link": "/live-streaming-macos/other/local-media-recording"
                }
        ]}
    />
    <br/>
    <FeatureList
      ...
      features={        [
                {
                        "title": "播放透明礼物特效",
                        "link": "/live-streaming-macos/other/play-transparent-gift-effects"
                }
        ]}
    />
  </Step>
  <Step title="最佳实践" icon="https://doc-media.zego.im/sdk-doc/Pics/Express/overview_catalog/icon_documentation_zuijiashijian.png">
    <FeatureList
      features={        [
                {
                        "title": "调试与配置",
                        "link": "/live-streaming-macos/best-practice/debug-and-config"
                },
                {
                        "title": "限制说明",
                        "link": "/live-streaming-macos/best-practice/restrictions"
                }
        ]}
    />
  </Step>
