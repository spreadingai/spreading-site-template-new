---
title: '主题 | Novel.sh'
description: 'Novel.sh 主题为你提供了布局、样式和其他功能，帮助你专注于 Markdown 内容的写作。'
---
# 主题

Novel.sh 主题为你提供了布局、样式和其他功能，帮助你专注于 Markdown 内容的写作。

## 默认主题

Novel.sh 有一个开箱即用的默认主题，正使用在你当前正在浏览的文档网站上。
...
社区用户创建了很多主题，并将它们发布到了 [NPM](https://www.npmjs.com/search?q=keywords:Novel.sh-theme) 上。查看主题本身的文档可以获取更详细的指引。
