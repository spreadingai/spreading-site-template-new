...
<NpmBadge package="@Novel.sh/bundler-webpack" />

Webpack 打包工具是由 [@Novel.sh/bundler-webpack](https://www.npmjs.com/package/@Novel.sh/bundler-webpack) 包提供的。它是 [Novel.sh-webpack](https://www.npmjs.com/package/Novel.sh-webpack) 包的依赖之一，当然你也可以单独安装它：

```bash
npm i -D @Novel.sh/bundler-webpack@next
```
...
```ts
import { webpackBundler } from '@Novel.sh/bundler-webpack'
