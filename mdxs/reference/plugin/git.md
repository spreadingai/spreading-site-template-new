...
<NpmBadge package="@Novel.sh/plugin-git" />
...
```bash
npm i -D @Novel.sh/plugin-git@next
```

```ts
import { gitPlugin } from '@Novel.sh/plugin-git'
...
import type { GitPluginPageData } from '@Novel.sh/plugin-git'
