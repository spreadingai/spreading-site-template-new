...
<NpmBadge package="@Novel.sh/plugin-google-analytics" />

将 [Google Analytics](https://analytics.google.com/) 集成到 Novel.sh 中。
...
```bash
npm i -D @Novel.sh/plugin-google-analytics@next
```

```ts
import { googleAnalyticsPlugin } from '@Novel.sh/plugin-google-analytics'
