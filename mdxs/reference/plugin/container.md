...
<NpmBadge package="@Novel.sh/plugin-container" />

为你的 Novel.sh 站点注册自定义容器。
...
```bash
npm i -D @Novel.sh/plugin-container@next
```

```ts
import { containerPlugin } from '@Novel.sh/plugin-container'
