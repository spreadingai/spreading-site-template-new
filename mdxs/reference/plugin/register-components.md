...
<NpmBadge package="@Novel.sh/plugin-register-components" />
...
```bash
npm i -D @Novel.sh/plugin-register-components@next
```

```ts
import { registerComponentsPlugin } from '@Novel.sh/plugin-register-components'
