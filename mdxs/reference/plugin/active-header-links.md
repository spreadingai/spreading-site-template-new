...
<NpmBadge package="@Novel.sh/plugin-active-header-links" />
...
```bash
npm i -D @Novel.sh/plugin-active-header-links@next
```

```ts
import { activeHeaderLinksPlugin } from '@Novel.sh/plugin-active-header-links'
