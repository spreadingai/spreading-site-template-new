...
Novel.sh 主题同样是一个插件，因此主题 API 可以接收 [插件 API](./plugin-api.md) 的所有选项，但存在以下差别：
...
- 详情：
  ...
  - 非 Scoped: `Novel.sh-theme-foo`
  - Scoped: `@org/Novel.sh-theme-foo`
...
- 类型： `TemplateRenderer` from `@Novel.sh/utils`
