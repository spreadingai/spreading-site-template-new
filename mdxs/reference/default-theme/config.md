...
```ts
import { defaultTheme } from '@Novel.sh/theme-default'
...
- 详情：
  ...
  是否启用 [@Novel.sh/plugin-active-header-links](../plugin/active-header-links.md) 。
...
- 详情：
  ...
  是否启用 [@Novel.sh/plugin-back-to-top](../plugin/back-to-top.md) 。
...
- 详情：
  ...
  是否启用由 [@Novel.sh/plugin-container](../plugin/container.md) 支持的自定义容器。
...
- 详情：
  ...
  是否启用 [@Novel.sh/plugin-external-link-icon](../plugin/external-link-icon.md) 。
...
- 详情：
  ...
  是否启用 [@Novel.sh/plugin-git](../plugin/git.md) 。
...
- 详情：
  ...
  是否启用 [@Novel.sh/plugin-medium-zoom](../plugin/medium-zoom.md) 。
...
- 详情：
  ...
  是否启用 [@Novel.sh/plugin-nprogress](../plugin/nprogress.md) 。
