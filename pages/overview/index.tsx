...
const readDoc = async () => {
  let originContent = fs.readFileSync(
    path.resolve("./mdxs", "getting_started.mdx"),
    "utf8"
  );
  ...
  return {
    slug: ["Novel.sh", "Getting Started", "Overview"],
    mdxSource,
  };
};
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        },
                        {
                          title: "快速上手",
                          type: "file",
                          key: "test project7/main/Novel.sh/Overview/getting-started/d22677f7",
                          isContentVisible: true,
                          children: [],
                        },
                        {
                          title: "目录结构",
                          type: "file",
                          key: "test project7/main/Novel.sh/Overview/directory-structure/d22677f7",
                          isContentVisible: true,
                          children: [],
                        },
                        {
                          title: "基本配置",
                          type: "file",
                          key: "test project7/main/Novel.sh/Overview/basic-config/d22677f7",
                          isContentVisible: true,
                          children: [],
                        },
                        {
                        ...
                        },
                        {
                          title: "静态资源",
                          type: "file",
                          key: "test project7/main/Novel.sh/Overview/assets/d22677f7",
                          isContentVisible: true,
                          children: [],
                        },
                        {
                          title: "Markdown 拓展",
                          type: "file",
                          key: "test project7/main/Novel.sh/Overview/markdown/d22677f7",
                          isContentVisible: true,
                          children: [],
                        },
                        {
                        ...
                        },
                        {
                          title: "多语言支持",
                          type: "file",
                          key: "test project7/main/Novel.sh/Overview/i18n/d22677f7",
                          isContentVisible: true,
                          children: [],
                        },

                        {
                          title: "部署",
                          type: "file",
                          key: "test project7/main/Novel.sh/Overview/deploy/d22677f7",
                          isContentVisible: true,
                          children: [],
                        },
                      ],
